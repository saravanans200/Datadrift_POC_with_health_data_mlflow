...
if __name__ == "__main__":
    ...
    encoded_data = pd.read_csv(csv_path('//data//meta_data(data_cleaned).csv'))
    input_example = encoded_data.iloc[[0]]
    ...
    exp = mlflow.set_experiment(experiment_name="Logistic")
    print('###########First Experiment Logistic #############')
    ...
    print("The artifact path is", artifacts_uri)
    mlflow.end_run()
    lr_results = [lr_train_accuracy_score, lr_train_recall_score, lr_train_precision_score, lr_train_f1_score, lr_bias, lr_var]
    print(lr_results)

    print("#################################decision#################################")

    exp = mlflow.set_experiment(experiment_name="decision")
    ...
    exp = mlflow.set_experiment(experiment_name="Xgboost")
